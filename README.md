...
[Download the latest](https://github.com/LadyEebs/JED-Light-Baker/releases/download/latest/Light.Baker.zip) or head over to the [Releases](https://github.com/LadyEebs/JED-Light-Baker/releases) page to download the version of your choosing.
